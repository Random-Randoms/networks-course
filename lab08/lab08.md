...
#### Демонстрация работы
Передается файл `send-pic.jpg`. На скринах -- логи клиента и сервера.
![alt text]({0EA339AD-65A2-448B-8984-D87387AF6DF7}.png)
![alt text]({D25FF219-396B-4CB5-878C-2FC8775E8C7C}.png)
...
**Реализация**
В файле `saw-server/src/main.rs`.
