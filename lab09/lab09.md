...
#### Вопросы
![alt text]({12F53D3A-6818-4779-8B9F-B44D0CB525A0}.png)
1. Каков IP-адрес вашего хоста? Каков IP-адрес хоста назначения?
   - 192.168.1.65
   - 103.69.124.8
2. Почему ICMP-пакет не обладает номерами исходного и конечного портов?
   - Так как ICMP не используется для управляющих сообщений между целыми хостами, а не приложениями,
     порты ему не нужны
...
4. Рассмотрите соответствующий ping-пакет, полученный в ответ на предыдущий. 
   ...
   ![alt text]({56F99D15-351D-4E6C-97D6-019726955443}.png)
   - echo-reply, 0
   - Checksum, Identifier, Sequence number
   - По 2 байта, в сумме 6
...
#### Вопросы
![alt text]({93A6D874-3EB1-4865-8014-9CBDEE21861A}.png)
...
1. Рассмотрите ICMP-пакет с эхо-запросом на вашем скриншоте. Отличается ли он от ICMP-пакетов с ping-запросами из Задания 1 (Ping)? Если да – то как?
   - Другие Sequence number, checksum
...
![alt text]({FDA9E2AC-D962-4355-ABCF-270BE0529991}.png)
   - Тут лежит заголовок и IP-дейтаграмма, которая за ttl-илась
...
![alt text]({DC6A9776-01FD-4FE3-AFFB-98FE29E45E16}.png)
   - Это успешные echo-reply на наши запросы
   - ttl хватило для того, чтобы добраться до целевого хоста -- и он ответил на
   наш эхо-запрос
...
![alt text]({2D4BE23C-964F-43E9-BD55-483ECB48E68B}.png)
Сайт американского правительства оказался в Стокгольме, так что пришлось запускать
`tracert` еще раз
   - Есть (12 - 13)
   - Видимо, подводный кабель
